...
public class NewsItemTest {
    ...
    private NewsItem newsItem1= new NewsItem(
            ...
            "https://www.krisinformation.se", "Julius", new Date(2019, 04, 10, 12, 59, 30));

    private NewsItem newsItem2= new NewsItem(
            "Min andra nyhet", "Denna ska ligga överst",
            "https://www.krisinformation.se", "Julius", new Date(2019, 04, 10, 13, 15, 20));

    @Test
    public void compareTo() {
        assertTrue(newsItem1.compareTo(newsItem2) == -1);
    }
}